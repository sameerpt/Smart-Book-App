...
export default function Dashboard() {
    ...
    // to fetch all inserted  bookmarks
    ...
    // instant update the inserted  or deleted bookmarks
    useEffect(() => {
        ...
        const initRealtime = async () => {
            ...
            console.log("Realtime subscribing with session");
            ...
            channel = supabaseClient
                ...
                .on(
                    ...
                    (payload) => {
                        console.log("🔥 Realtime INSERT/DELETE:", payload);
                        fetchBookmarks();
                    }
                )
                .subscribe((status) => {
    ...
    // to delete a bookmark from the ui and the db 
